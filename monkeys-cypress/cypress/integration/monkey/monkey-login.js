...
const url = Cypress.config('baseUrl') || "http://localhost:3011/ghost/#/site"
const appName = Cypress.env('appName')|| "Ghost Admin"
const events = Cypress.env('events')|| 600
...
beforeEach(() => {
    ...
    cy.visit('http://localhost:3001/ghost/#/site')
  })
