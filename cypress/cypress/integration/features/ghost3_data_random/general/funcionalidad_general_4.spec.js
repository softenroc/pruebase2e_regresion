...
describe("Feature: General", () => {
  ...
  it("Como owner/staff ingreso a General para modificar description por 50 caracteres y guarda", () => {
...
async function when_i_enter_a_description(){
    cy.readFile(path_data+'data_funcionalidad_general_4.json').then(data => {   
