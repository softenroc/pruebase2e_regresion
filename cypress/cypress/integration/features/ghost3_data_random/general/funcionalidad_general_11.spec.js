...
describe("Feature: General", () => {
  ...
  it("Como owner/staff ingreso a General para modificar Twitter card por 70 caracteres en Twitter title y guarda", () => {
...
async function when_i_enter_a_twitter_title(){
    cy.readFile(path_data+'data_funcionalidad_general_11.json').then(data => {   
