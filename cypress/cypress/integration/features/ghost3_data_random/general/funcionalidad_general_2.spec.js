...
describe("Feature: General", () => {
  ...
  it("Como owner/staff ingreso a General para modificar nombre por 50 caracteres y guarda", () => {
...
async function when_i_enter_a_name(){
    cy.readFile(path_data+'data_funcionalidad_general_2.json').then(data => {   
