...
describe("Feature: General", () => {
  ...
  it("Como owner/staff ingreso a General para modificar Lenguage por 50 caracteres y guarda", () => {
...
async function when_i_enter_a_lenguage(){
    cy.readFile(path_data+'data_funcionalidad_general_5.json').then(data => {   
