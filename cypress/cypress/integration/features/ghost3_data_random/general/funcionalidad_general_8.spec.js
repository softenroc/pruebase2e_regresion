...
describe("Feature: General", () => {
  ...
  it("Como owner/staff ingreso a General para modificar Meta title por 71 caracteres y guarda", () => {
...
async function when_i_enter_a_meta_title(){
    cy.readFile(path_data+'data_funcionalidad_general_8.json').then(data => {   
