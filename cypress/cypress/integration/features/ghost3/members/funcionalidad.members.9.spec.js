...
function newFunction() {
    ...
    describe("Feature: Members", () => {
        ...
        it("Como owner/staff ingreso a Members para crear un nuevo miembro con una nota de 499 caracteres y guarda", () => {
        ...
        async function when_i_enter_name_email_note() {
            cy.readFile(path_data + 'data_funcionalidad_members_9.json').then(data => {
