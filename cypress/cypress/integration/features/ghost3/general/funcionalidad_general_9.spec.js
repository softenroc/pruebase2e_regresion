...
describe("Feature: General", () => {
  ...
  it("Como owner/staff ingreso a General para modificar Meta description por 155 caracteres y guarda", () => {
...
async function when_i_enter_a_meta_description(){
    cy.readFile(path_data+'data_funcionalidad_general_9.json').then(data => {   
