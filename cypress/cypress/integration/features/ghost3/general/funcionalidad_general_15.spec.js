...
describe("Feature: General", () => {
  ...
  it("Como owner/staff ingreso a General para modificar social accounts Twitter URL en formato valido", () => {
...
async function when_i_enter_a_twitter_URL(){
    cy.readFile(path_data+'data_funcionalidad_general_15.json').then(data => {   
